...
const PerformanceIndicators = ({ indicators }: PerformanceIndicatorsProps) => {
  return (
    <Card className="gap-0 rounded-[16px] border-[#E5E5E5] bg-white py-0 shadow-none">
      ...
      <CardContent className="flex flex-col gap-4 px-4 py-8">
          ...
          return (
            ...
            >
              <div className="flex min-w-0 items-center gap-1.5">
                <span
                  className={`${style.bg} ${style.text} flex p-1 shrink-0 items-center justify-center rounded-[5px]`}
                >
        ...
        <div className="mt-1 flex min-h-17 items-center justify-between rounded-[16px] bg-primary px-7.5 py-4 text-white ring-2 ring-[#E5E5E5]">
          <div>
            <p className="text-[10px] font-bold uppercase">POS vs Mobile</p>
            <p className="mt-1 text-[14px]">Revenue Mix</p>
          </div>
          <div>
            <p className="text-[14px] font-bold">63% POS</p>
