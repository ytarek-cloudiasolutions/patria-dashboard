...
const FORM_ID = "waste-voucher-form";

interface WasteVoucherDialogProps {
  open: boolean;
...
const WasteVoucherDialog = ({
  open,
  onOpenChange,
  onConfirm,
}: WasteVoucherDialogProps) => {
...
export default WasteVoucherDialog;
