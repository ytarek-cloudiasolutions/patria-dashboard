              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="flex flex-col">
                  ...
                  <DatePicker
                    ...
                    withBackdrop
                    buttonClassName="h-12 rounded-[12px] border-[#E5E5E5] px-4 text-[16px] font-normal text-black"
                  />
                </div>
              </div>
...
export default NewPeriodBalanceDialog;
